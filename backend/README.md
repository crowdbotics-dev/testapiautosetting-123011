...
## Project Structure
    ...
    ├── testapiautosetting_123011  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123011`
...
2. Clone this repo and `cd testapiautosetting_123011`
